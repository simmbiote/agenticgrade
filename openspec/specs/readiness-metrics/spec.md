# readiness-metrics Specification

## Purpose

Define the catalog of agentic-readiness metrics — grouped into six categories, some base metrics and some provider-scoped — and their detection rules against a scanned repo file tree.
